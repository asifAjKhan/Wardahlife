  ...
  settings: [
    {
      ...
      site: {
        name: 'wardahlife',
        description:
          'wardahlife is a sample Ecommerce website built with Next.js, Tailwind CSS, and MongoDB.',
        keywords: 'Next Ecommerce, Next.js, Tailwind CSS, MongoDB',
        url: 'https:/wardahlife.com',
        logo: '/icons/logo.svg',
        slogan: 'Spend less, enjoy more.',
        author: 'Next Ecommerce',
        copyright: '2000-202r, Next-Ecommerce.com, Inc. or its affiliates',
        email: 'admin@example.com',
      ...
      availableCurrencies: [
        ...
        { name: 'bdt', code: 'BDT', symbol: '৳', convertRate: 121.45 },
      ],
      defaultCurrency: 'USD',
